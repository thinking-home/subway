...
Мост между локальным сервером умного дома и Яндекс Алисой: облачный прокси даёт
...
> - [deploy](deploy/README.md) — деплой прокси (VM + Caddy + systemd)
...
В настройках навыка укажите адреса (домен — тот, на котором развёрнут прокси):
